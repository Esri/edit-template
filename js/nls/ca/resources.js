...
define({
  "map": {
    "noEditLayers": "Aquest mapa web no conté cap capa editable.",
    "noEditPrivileges": "El vostre compte no té permisos d'edició. Poseu-vos en contacte amb l'administrador per obtenir més ajuda.",
  ...
  "tools": {
    ...
    "popup": {
      "title": "Informació",
      "instructions": "Seleccioneu una entitat al mapa per veure'n els detalls."
    }
  }
});