 ...
 */
define(["dojo/_base/declare", "dojo/Deferred", "dojo/has", "dojo/_base/lang", "dojo/_base/kernel", "dojo/_base/Color", "dojo/_base/array", "dojo/on", "dijit/registry", "esri/arcgis/utils", "esri/lang", "dojo/dom", "dojo/dom-geometry", "dojo/dom-attr", "dojo/dom-style", "dojo/query", "dojo/dom-construct", "dojo/dom-class", "application/Drawer", "esri/layers/FeatureLayer", "esri/dijit/editing/Editor", "esri/toolbars/edit", "esri/dijit/AttributeInspector", "esri/tasks/query", "esri/domUtils", "application/SearchSources", "dojo/domReady!"], function (
    declare, Deferred, has, lang, kernel, Color, array, on, registry, arcgisUtils, esriLang, dom, domGeometry, domAttr, domStyle, query, domConstruct, domClass, Drawer, FeatureLayer, Editor, Edit, AttributeInspector, esriQuery, domUtils, SearchSources) {
    return declare(null, {
        config: {},
        editor: null,
        editable: false,
